...
def makeIn(fileName, elementLine, startElement, stopElement, initDistribFile='/home/vmsim/Desktop/V2/ASTRA/temp-start.ini' , zStart_offset=0.0,charge=0.25):
    ...
    lines = w.DISTRIBWriter(lines,initDistribFile)
    lines = w.SPACEQWriter(lines, 1)#for now always have it off
    lines = w.QBUNCHWriter(lines,charge)
