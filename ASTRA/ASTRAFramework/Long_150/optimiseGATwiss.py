...
class fitnessFunc():
    ...
    def __init__(self, args, tempdir, npart=4096, ncpu=4, overwrite=True, verbose=False, summary=False):
        ...
        astra.fileSettings['long_150.2']['quad_K'] = self.parameters[0:6]
        astra.fileSettings['long_150.3']['quad_K'] = self.parameters[6:14]
        astra.fileSettings['long_150.4']['quad_K'] = self.parameters[14:16]
        astra.fileSettings['long_150.5']['quad_K'] = self.parameters[16:]
        bcangle = float(astra.fileSettings['vb_long_150']['variable_bunch_compressor']['angle'])
        ...
        astra.fileSettings['long_150.5']['starting_distribution'] = 'end.fmt2.astra'
        ''' Create ASTRA files based on settings '''
        astra.applySettings()
        ''' Run ASTRA upto VBC '''
        astra.runASTRAFiles(files=['long_150.1','long_150.2','long_150.3','long_150.4'])
        ...
        astra.runASTRAFiles(files=['long_150.5'])
    ...
    def calculateTwissParameters(self):
        ...
        twiss.read_astra_emit_files(self.dirname+'/long_150.2.Zemit.001')
        constraintsList2 = {
        ...
        # 4HC
        twiss.read_astra_emit_files(self.dirname+'/long_150.3.Zemit.001')
        constraintsList3 = {
        ...
        # VBC
        twiss.read_astra_emit_files(self.dirname+'/long_150.4.Zemit.001')
        constraintsList4 = {
        ...
        twiss.read_astra_emit_files(self.dirname+'/long_150.5.Zemit.001')
        constraintsList5 = {
...
astra.loadSettings('long_150_12b3.settings')
parameters = []
parameters.append(astra.fileSettings['long_150.2']['quad_K'])
parameters.append(astra.fileSettings['long_150.3']['quad_K'])
parameters.append(astra.fileSettings['long_150.4']['quad_K'])
parameters.append(astra.fileSettings['long_150.5']['quad_K'])
