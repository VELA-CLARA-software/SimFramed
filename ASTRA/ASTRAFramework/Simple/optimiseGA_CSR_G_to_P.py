...
class fitnessFunc():
    ...
    def calculateBeamParameters(self):
        ...
        try:
            ...
            self.csrtrack.writeCSRTrackFile('csrtrk.in', angle=bcangle, forces='csr_g_to_p', inputfile='../CSRTest_Base/test.4.2573.001')
            ''' Run CSRTrack'''
            ...
            if self.summary:
                self.astra.createHDF5Summary(reference='CSR_G_to_p')
            return fitness
        except:
            return 1e6
...
best = parameters
print optfunc(best, dir=os.getcwd()+'/longitudinal_best_CSR_G_to_p', npart=2**16, ncpu=40, overwrite=True, verbose=True, summary=True)
exit()
