...
def optimise_Lattice():
    ...
    quads = [19.27190175, -17.69572111,   7.0315249,   -5.1809911,    2.34047285,   3.39357893]
    # quads = setVELA(quads)
    optFuncVELA(quads)
    print 'VELA = ', quads
...
optimise_Lattice()
elegantNoSCOut = open('elegant_NoSC_phase_data.csv','wb')
elegantSCOut = open('elegant_SC_phase_data.csv','wb')
