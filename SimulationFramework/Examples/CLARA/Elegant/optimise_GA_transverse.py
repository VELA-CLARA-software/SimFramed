...
class fitnessFunc():
    ...
    def calculateBeamParameters(self):
        try:
            ...
            twiss.read_elegant_twiss_files( [ self.dirname+'/'+n+'.twi' for n in ['S02', 'L02', 'S03', 'L03', 'S04', 'L4H', 'S05', 'VBC', 'S06', 'L04', 'S07']])
...
# allbest=[]
# with open('transverse_best_solutions.csv','r') as infile:
...
# print optfunc(best, dir=os.getcwd()+'/test_transverse', scaling=4, overwrite=True, verbose=False, summary=False)
# exit()
...
if os.name == 'nt':
    toolbox.register("evaluate", optfunc, scaling=4, verbose=False)
else:
    toolbox.register("evaluate", optfunc, scaling=4, verbose=False)
