...
if os.name == 'nt':
    nProc = 11 #change this, if more than 1 doesn't show useful errors
else:
    nProc = 11

populationSize = 1*nProc
...
class UltrashortMOGA(MOGA):
    ...
    parameter_names = [
        ...
        ['CLA-S07-DCP-01', 'factor', 0.1, 0.02],
    ...
    def MOGAoptFunc(self, inputargs, *args, **kwargs):
        ...
        fitness = max_xrms*energy_spread/peak_current #doesn't do much atm
        print ('fitvalue[', self.opt_iteration, '] - eSpread=', energy_spread, '  peakI=', peak_current, '  Xmax=', max_xrms, '  fitness=', fitness)
        self.saveState(inputargs, self.opt_iteration, [energy_spread, peak_current, max_xrms], fitness)
