...
with open('best_solutions_running_simplex.csv','w') as out:
    pass
res = minimize(optfunc3, best, method='nelder-mead', options={'xtol': 1e-3, 'disp': True})
print res

try:
    print 'best fitness = ', optfunc(res.x, dir=os.getcwd()+'/CLARA_best_longitudinal_simplex_2', scaling=6, overwrite=True, verbose=True, summary=True, post_injector=True)
except:
    pass
