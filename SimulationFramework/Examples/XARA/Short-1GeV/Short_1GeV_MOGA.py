...
from SimulationFramework.Examples.CLARA.Elegant_Genesis.genesisBeamFileMOGA import MOGA
...
if __name__ == "__main__":
    if not os.name == 'nt':
        ...
        nProc = 1
    moga.create_toolbox()
    moga.create_fitness_function(optfunc, scaling=5, post_injector=True, changes='./transverse_best_changes.yaml', lattice='Lattices/claraX400_v12_80MVm_Elegant.def')
