...
results = []
with open('CLARA_longitudinal_best_solutions.csv.tmp', 'r') as csvfile:
...
#fit = FF.fitnessFunc(best, os.getcwd()+'/test_5', scaling=5, overwrite=True, verbose=True, summary=False)
...
if __name__ == "__main__":
    ...
    pop, logbook = opt.eaSimple(pop, toolbox, cxpb=0.5, mutpb=0.2, ngen=10,
