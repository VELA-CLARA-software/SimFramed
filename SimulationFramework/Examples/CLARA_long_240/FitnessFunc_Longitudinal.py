...
class fitnessFunc():
    ...
    def calculateBeamParameters(self):
        ...
        try:
            ...
            constraintsList = {
                'peakI_min': {'type': 'greaterthan', 'value': abs(peakI), 'limit': 110, 'weight': 60},
                'peakI_max': {'type': 'lessthan', 'value': abs(peakI), 'limit': 200, 'weight': 10},
                ...
                'horizontal emittance': {'type': 'lessthan', 'value': emitx, 'limit': 0.5, 'weight': 20},
                'vertical emittance': {'type': 'lessthan', 'value': emity, 'limit': 0.5, 'weight': 20},
