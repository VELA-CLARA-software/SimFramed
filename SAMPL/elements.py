...
class cavity():
        def __init__(self, name, controllerObject, fieldMap, position, nue,
                     numb=1, length):
            self.name = name
            # controller info
...
class solenoid():
    def __init__(self, name, controllerObject, fieldMap, position, length):
        self.name = name
        # controller info
        self.object = controllerObject
        # ASTRA info
...
class dipole():
    def __init__(self, name, controllerObject,
                 D1, D2, D3, D4, Gap1, Gap2, length):
        self.name = name
        # controller data
        self.object = controllerObject
        # ASTRA info
        ...
        self.Gap1 = Gap1
        self.Gap2 = Gap2
        self.length = (self.object.magneticLength / 1000)
