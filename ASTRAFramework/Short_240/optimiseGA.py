...
if os.name == 'nt':
    ...
    toolbox.register("evaluate", optfunc, npart=4096)
...
if __name__ == "__main__":
    ...
    try:
        print 'best fitness = ', optfunc(hof[0], dir=os.getcwd()+'/longitudinal_best', npart=4096, ncpu=40, overwrite=True, verbose=True, summary=True)
