...
class fitnessFunc():
    ...
    def __init__(self, args, tempdir, npart=10000, ncpu=6, overwrite=True, verbose=False, summary=False):
        ...
        self.astra.fileSettings['vb']['LSPCH'] = False
    ...
    def calculateBeamParameters(self):
        ...
        try:
            ...
            if self.summary:
                self.astra.createHDF5Summary(reference='NoCSR_ASTRA_NoSC')
            return fitness
        except:
            return 1e6
...
best = parameters
print optfunc(best, dir=os.getcwd()+'/longitudinal_best_NoCSR_ASTRA_NoSC', npart=2**16, ncpu=20, overwrite=True, verbose=True, summary=True)
exit()
