...
class fitnessFunc():
    ...
    def calculateBeamParameters(self):
        ...
        try:
            ...
            self.csrtrack.writeCSRTrackFile('csrtrk.in', angle=bcangle, forces='none', inputfile='../CSRTest_Base/test.4.2573.001')
            ''' Run CSRTrack'''
            ...
            if self.summary:
                self.astra.createHDF5Summary(reference='NoCSR')
            return fitness
        except:
            return 1e6
...
best = parameters
print optfunc(best, dir=os.getcwd()+'/longitudinal_best_NoCSR', npart=2**16, ncpu=20, overwrite=True, verbose=True, summary=True)
exit()
