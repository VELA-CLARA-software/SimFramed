    ...
    def calculateBeamParameters(self):
        ...
        try:
            ...
            constraintsList = {
                ...
                'peakIEmittanceX': {'type': 'lessthan', 'value': 1e6*peakIEmittanceX, 'limit': 0.5, 'weight': 2.5},
                'peakIEmittanceY': {'type': 'lessthan', 'value': 1e6*peakIEmittanceY, 'limit': 0.5, 'weight': 2.5},
                ...
                'horizontal emittance': {'type': 'lessthan', 'value': emitx, 'limit': 0.75, 'weight': 4},
                'vertical emittance': {'type': 'lessthan', 'value': emity, 'limit': 0.75, 'weight': 4},
            }
...
# results = []
# with open('longitudinal_best_Short_240_solutions.csv', 'r') as csvfile:
...
# print optfunc(best, dir=os.getcwd()+'/best_longitudinal', scaling=3, overwrite=True, verbose=True, summary=False)
# exit()
